...
const checkColour = async (req, res) => {
  const { id: colourCode } = req.params
  const clientColour = await Client.findOne({ bgcolor: colourCode })
...
export { listClient, addClient, updateClient, deleteClient, checkColour }
